...
public class WeatherController {
     ...
     * @return
     */
    public Instant persistTemperature(int hour, double temperature) {
        // Get the current time
        Instant currentTime = Instant.now();
        
        // Simulate persistence action and return the current time
        System.out.println("Temperature: " + temperature + " of hour: " + hour + ", saved at " + currentTime);
    ...
    public ZoneId getSystemDefaultZone() {
        return ZoneId.systemDefault();
    }

    public void setClock(Clock fixed) {
        // Implementation for setting clock if needed
    }
}
